...
# 사용자 권한 문제 해결 스크립트 (2024-12-19)
# 설명: root 대신 dmanager 계정으로 PM2 프로세스를 실행하도록 설정합니다.

set -e

echo "🔧 사용자 권한 문제를 해결합니다..."
...
echo ""
echo "=========================================="
echo "🔧 사용자 권한 문제 해결 완료!"
echo "=========================================="
echo ""

log_success "사용자 권한 문제 해결이 완료되었습니다! 🎉"
echo ""
echo "📝 중요 사항:"
echo "  - PM2 프로세스가 dmanager 계정으로 실행됩니다."
