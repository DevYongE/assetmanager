...
# =============================================================================
# Nginx 정적 파일 서빙 문제 해결 스크립트
# =============================================================================
#
# 이 스크립트는 Nginx에서 Nuxt.js 정적 파일들이 제대로 서빙되지 않는
# 문제를 해결합니다. _nuxt 디렉토리와 기타 정적 파일들의 프록시 설정을
# 추가하여 404 오류를 해결합니다.
#
# 작성일: 2025-01-27
# =============================================================================

echo "🔧 Nginx 정적 파일 서빙 문제를 해결합니다..."
echo ""
...
echo ""
echo "프론트엔드 상태 확인..."
pm2 status | grep qr-frontend || echo "❌ 프론트엔드 프로세스 없음"

echo ""
echo "백엔드 상태 확인..."
pm2 status | grep qr-backend || echo "❌ 백엔드 프로세스 없음"
